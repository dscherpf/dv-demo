<script type="ts">
    ...
    // import data from '../assets/cleaned_chemical_tx.json';
    ...
    function fetchData() {
        fetch('src/assets/data/chemical_plant_dataset_tx.json')
            .then((res) => res.json())
            .then((data) => console.log(data));
    }

    // async function fetchData() {
    // let response = await fetch('../assets/cleaned_chemical_tx.json');
